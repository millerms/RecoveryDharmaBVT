...
<div class="zen-hero-banner">
  <picture>
    <source srcset="{{ '/assets/images/rd-icons/rdvt-icon-kensho-new.png' | relative_url }}" type="image/png">
    <img src="{{ '/assets/images/rd-icons/rdvt-icon-kensho-new.png' | relative_url }}" alt="RDVT Icon">
  </picture>
</div>
