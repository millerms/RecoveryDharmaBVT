...
<div class="fade-in">
  <div style="position: relative; text-align: center; max-width: 100%; margin-top: 1rem;">
    ...
    <div style="position: absolute; top: 50%; right: 0; width: 50%; transform: translateY(-55%); text-align: right; padding-right: 2rem; color: white; font-weight: bold; font-size: clamp(0.85rem, 2.3vw, 1.2rem); text-shadow: 0 2px 6px rgba(0,0,0,0.5);">
      Freedom begins with seeing clearly.
    </div>
  </div>
</div>
...
<div class="reveal reveal--up" markdown="1">
  <div style="position: relative; text-align: center; max-width: 100%; margin-top: 1rem;">
    ...
    <div style="position: absolute; bottom: 5%; left: 50%; transform: translateX(-50%); width: 80%; text-align: center; color: white; font-weight: bold; font-size: clamp(0.9rem, 2.5vw, 1.5rem); text-shadow: 0 2px 6px rgba(0,0,0,0.5);">
      Ethics, awareness, and compassion can support recovery.
    </div>
  </div>
</div>
...
<details class="accordion reveal reveal--up">
  <summary>The Five Precepts</summary>
  ...
  1. **To refrain from harming living beings**: Supporting compassion and nonviolence  
  2. **To refrain from taking what is not given**: Supporting honesty and integrity  
  3. **To refrain from sexual misconduct**: Supporting respect and care in relationships  
  4. **To refrain from false speech**: Supporting truthfulness and more thoughtful communication  
  5. **To refrain from intoxicants that cloud the mind**: Supporting clarity and awareness
  </div>
  
</details>

<h3 id="the-four-noble-truths--addiction" class="sr-only">The Four Noble Truths & Addiction</h3>
<details class="accordion reveal reveal--up">
  ...
  1. **There Is Suffering (Dukkha)**: Dissatisfaction is a natural part of life and can show up in many ways: suffering, unease, and a sense of “not enough.” Addiction often begins as an attempt to find relief from this. Much of this suffering is shaped by how we interpret and push against our experience. This part of the path is about learning to recognize and understand that more clearly.
  2. **Craving (Tanha) Plays a Central Role**: Craving, whether physical, emotional, or psychological, helps keep the cycle going. It often shows up when something feels uncomfortable, and the mind looks for a quick way to feel better.
  3. **A Different Relationship Is Possible**: Recovery becomes possible as we learn to relate to craving differently, instead of automatically acting on it. Over time, this can soften its intensity and pull.
  4. **There Is a Path of Practice**: The Eightfold Path offers a way of working with suffering through understanding, ethical choices, mindful awareness, and steady effort. With practice, we can learn new ways to respond to pain and uncertainty.
...
<h3 id="the-eightfold-path" class="sr-only">The Eightfold Path</h3>
<details class="accordion reveal reveal--up">
  <summary>The Eightfold Path</summary>
  <div class="accordion__content" markdown="1">
...
{: .reveal .reveal--up }
<h3 id="practices" class="sr-only">Meditations</h3>
<details class="accordion reveal reveal--up">
  <summary>Selected Meditations</summary>
  <div class="accordion__content" markdown="1">

  - **[Vipassanā (Insight Meditation):](https://www.youtube.com/watch?v=tw7XBKhZJh4)** A practice of observing sensations, thoughts, and emotions with increasing clarity and steadiness  
      
  - **[Metta (Loving-Kindness):](https://insighttimer.com/recoverydharma/guided-meditations/metta-lovingkindness-2)** A practice that develops goodwill and care toward yourself and others  
      
  - **[Compassion (Karuna):](https://insighttimer.com/nutjob4life/guided-meditations/compassion-meditation-from-recovery-dharma)** A way of relating to suffering with care, both your own and others  
      
  - **[Tonglen (Giving & Taking):](https://www.youtube.com/watch?v=amrGu1oHsvQ)** A practice of working with empathy by intentionally connecting with suffering and relief
  </div>
...
<details class="accordion reveal reveal--up">
  <summary>Classic &amp; Foundational Texts</summary>
  <div class="accordion__content" markdown="1">
...
<h4 id="accessible--contemporary-introductions" class="sr-only">Accessible &amp; Contemporary Introductions</h4>
<details class="accordion reveal reveal--up">
  ...
  - **[Mindfulness: A Practical Guide to Awakening](https://www.goodreads.com/book/show/17689433-mindfulness)** - *by Joseph Goldstein*  
  ...
  - **[Seeing That Frees](https://www.goodreads.com/book/show/25172403-seeing-that-frees)** - *by Rob Burbea*  
...
<h3 id="podcasts" class="sr-only">Podcasts</h3>
<details class="accordion reveal reveal--up">
...
<h3 id="videos" class="sr-only">Videos</h3>
<details class="accordion reveal reveal--up">
